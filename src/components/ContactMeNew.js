            ...
            <div className="flex flex-col md:flex-row items-center justify-center bg-sky-700 space-x-0 md:space-x-40">
                ...
                <div className=" bg-white rounded-3xl py-10 -mb-4 md:-my-24 z-40 px-8  sm:px-12 sm:w-[384px] h-[505px]">
                    <form ref={form} onSubmit={sendEmail} className={` transform duration-75 ${clicked ? "hidden" : "block"}`}>
                        ...
                        <button type="submit" className='w-full grid place-content-center rounded-xl py-2 text-white mt-4 tracking-wide text-lg bg-sky-500 hover:bg-sky-600 active:bg-sky-900 active:shadow-inner'
                        > Submit</button>
                    </form>
                        ...
                        {isSent &&
                            (
                                <div className="flex flex-col items-center justify-center">
                                    <div className=" p-3 mb-8 rounded-full bg-sky-800">
                                        <CheckCircleIcon className='w-6 h-6 text-sky-50' />
                                    </div>
