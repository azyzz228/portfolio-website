            ...
            <Container>
                ...
                <div className="flex flex-col-reverse lg:flex-row justify-between items-center px-12 sm:px-16 lg:pl-32 lg:pr-24 relative">
                    ...
                    <div className=" max-w-xs -mx-4 lg:max-w-sm flex flex-row-reverse lg:flex-row items-end  relative">
                        <svg viewBox="0 0 200 200" className='absolute sm:hidden' xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col items-center text-xl text-slate-300 sm:text-sky-200 py-24 pl-8 pr-8  space-y-6 z-30">
                            <i class="fab fa-instagram hover:text-sky-50 transform duration-200 hover:scale-110"></i>
                            <i class="fab fa-github hover:text-sky-50 transform duration-200 hover:scale-110"></i>
                            <i class="fab fa-linkedin-in hover:text-sky-50 transform duration-200 hover:scale-110"></i>
                        </div>
